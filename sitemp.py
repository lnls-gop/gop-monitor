...
class ConnWidgetPVs(QtWidgets.QWidget):
    ...
    def atualizar_status(self):
        ...
        elif self.check_type == 'racksimar':
        ...
        elif self.check_type == 'temprackint':
        ...
        elif self.check_type == 'conectserv':
...
class Si_rackint(ConnWidgetPVs):
    ...
    def _registrar_grupos(self):
        ...
        self.sinais = {
            ...
            (self.uiobj.led01ractrl, 19, 32),
            'IA-01RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led01rabpm, 19, 32),
            'IA-01RaSepSI:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led01rasepsi, 19, 32),
            'IA-01RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led01raps01, 19, 32),
            'IA-01RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led01raps02, 19, 32),
            'IA-01RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led01ravac, 19, 32),
            'IA-01RaInjBO:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led01rainjbo, 19, 32),
            # 'IA-01RaNLK:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led01ranlk, 19, 32),
            'IA-02RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led02ractrl, 19, 32),
            'IA-02RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led02rabpm, 19, 32),
            'IA-02RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led02raps01, 19, 32),
            'IA-02RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led02raps02, 19, 32),
            'IA-02RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led02ravac, 19, 32),
            'IA-03RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led03ractrl, 19, 32),
            'IA-03RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led03rabpm, 19, 32),
            'IA-03RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led03raps01, 19, 32),
            'IA-03RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led03raps02, 19, 32),
            'IA-03RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led03ravac, 19, 32),
            'IA-04RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led04ractrl, 19, 32),
            'IA-04RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led04rabpm, 19, 32),
            'IA-04RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led04raps01, 19, 32),
            'IA-04RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led04raps02, 19, 32),
            'IA-04RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led04ravac, 19, 32),
            'IA-05RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led05ractrl, 19, 32),
            'IA-05RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led05rabpm, 19, 32),
            'IA-05RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led05raps01, 19, 32),
            'IA-05RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led05raps02, 19, 32),
            'IA-05RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led05ravac, 19, 32),
            'IA-06RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led06ractrl, 19, 32),
            'IA-06RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led06rabpm, 19, 32),
            'IA-06RaUnd:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led06raund, 19, 32),
            'IA-06RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led06raps01, 19, 32),
            'IA-06RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led06raps02, 19, 32),
            'IA-06RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led06ravac, 19, 32),
            'IA-07RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led07ractrl, 19, 32),
            'IA-07RaUnd:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led07raund, 19, 32),
            'IA-07RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led07raps01, 19, 32),
            'IA-07RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led07raps02, 19, 32),
            # 'IA-07RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led07ravac, 19, 32),
            'IA-08RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led08ractrl, 19, 32),
            'IA-08RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led08rabpm, 19, 32),
            'IA-08RaUnd:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led08raund, 19, 32),
            'IA-08RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led08raps01, 19, 32),
            # 'IA-08RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led08raps02, 19, 32),
            'IA-08RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led08ravac, 19, 32),
            'IA-09RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led09ractrl, 19, 32),
            'IA-09RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led09rabpm, 19, 32),
            'IA-09RaUnd:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led09raund, 19, 32),
            'IA-09RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led09raps01, 19, 32),
            'IA-09RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led09raps02, 19, 32),
            'IA-09RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led09ravac, 19, 32),
            'IA-10RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led10ractrl, 19, 32),
            'IA-10RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led10rabpm, 19, 32),
            'IA-10RaUnd:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led10raund, 19, 32),
            'IA-10RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led10raps01, 19, 32),
            'IA-10RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led10raps02, 19, 32),
            'IA-10RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led10ravac, 19, 32),
            'IA-11RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led11ractrl, 19, 32),
            'IA-11RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led11rabpm, 19, 32),
            'IA-11RaUnd:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led11raund, 19, 32),
            'IA-11RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led11raps01, 19, 32),
            'IA-11RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led11raps02, 19, 32),
            'IA-11RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led11ravac, 19, 32),
            'IA-12RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led12ractrl, 19, 32),
            'IA-12RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led12rabpm, 19, 32),
            'IA-12RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led12raps01, 19, 32),
            'IA-12RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led12raps02, 19, 32),
            'IA-12RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led12ravac, 19, 32),
            'IA-13RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led13ractrl, 19, 32),
            'IA-13RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led13rabpm, 19, 32),
            'IA-13RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led13raps01, 19, 32),
            'IA-13RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led13raps02, 19, 32),
            'IA-13RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led13ravac, 19, 32),
            'IA-14RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led14ractrl, 19, 32),
            'IA-14RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led14rabpm, 19, 32),
            'IA-14RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led14raps01, 19, 32),
            'IA-14RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led14raps02, 19, 32),
            'IA-14RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led14ravac, 19, 32),
            'IA-14RaDiag03:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led14radiag, 19, 32),
            'IA-15RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led15ractrl, 19, 32),
            'IA-15RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led15rabpm, 19, 32),
            'IA-15RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led15raps01, 19, 32),
            'IA-15RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led15raps02, 19, 32),
            'IA-15RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led15ravac, 19, 32),
            'IA-16RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led16ractrl, 19, 32),
            'IA-16RaBbB:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led16rabbb, 19, 32),
            'IA-16RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led16rabpm, 19, 32),
            'IA-16RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led16raps01, 19, 32),
            'IA-16RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led16raps02, 19, 32),
            'IA-16RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led16ravac, 19, 32),
            'IA-17RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led17ractrl, 19, 32),
            'IA-17RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led17rabpm, 19, 32),
            'IA-17RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led17raps01, 19, 32),
            'IA-17RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led17raps02, 19, 32),
            'IA-17RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led17ravac, 19, 32),
            'IA-18RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led18ractrl, 19, 32),
            'IA-18RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led18rabpm, 19, 32),
            'IA-18RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led18raps01, 19, 32),
            'IA-18RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led18raps02, 19, 32),
            # 'IA-18RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led18ravac, 19, 32),
            # 'IA-19RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led19ractrl, 19, 32),
            # 'IA-19RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led19rabpm, 19, 32),
            # 'IA-19RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led19raps01, 19, 32),
            # 'IA-19RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            # (self.uiobj.led19raps02, 19, 32),
            'IA-19RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led19ravac, 19, 32),
            'IA-19RaEPP:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led19raepp, 19, 32),
            # 'IA-19RaVAC02:CO-SIMAR-02:RackInternalTemp-Mon':
            # (self.uiobj.led19ravac02, 19, 32),
            'IA-20RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20ractrl, 19, 32),
            'IA-20RaBPM:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20rabpm, 19, 32),
            'IA-20RaPS01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20raps01, 19, 32),
            'IA-20RaPS02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20raps02, 19, 32),
            'IA-20RaVAC:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20ravac, 19, 32),
            'IA-20RaDiag01:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20radiag01, 19, 32),
            'IA-20RaBPMTL:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20rabpmtl, 19, 32),
            'IA-20RaEPP:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20raepp, 19, 32),
            'IA-20RaDiag02:CO-SIMAR-01:RackInternalTemp-Mon':
            (self.uiobj.led20radiag02, 19, 32),
        }


class Si_conecserv(ConnWidgetPVs):
    """Classe responsável pelo controle do sistema de temperatura Booster."""
    ...
    def _registrar_grupos(self):
        """Registra os grupos de PVs/LEDs e suas faixas."""
        self.sinais = {
            'CA-RaCtrl:CO-SIMAR-01:RackInternalTemp-Mon': (self.uiobj.
                                                           led_ctrl, 28, 32),
            'CA-RaInter:CO-SIMAR-01:RackInternalTemp-Mon': (self.uiobj.
                                                            led_inter, 25, 30),
            'CA-RaTim:CO-SIMAR-01:RackInternalTemp-Mon': (self.uiobj.led_tim,
                                                          23, 25),
            'RoomSrv:CO-SIMAR-01:AmbientTemp-Mon': (self.uiobj.led_server, 17,
                                                    21),
            'CA:CO-SIMAR-01:AmbientTemp-Mon': (self.uiobj.led_ambient, 21, 24),

        }


class Si_camvac(ConnWidgetPVs):
    """Classe responsável pelo controle do sistema de temperatura Booster."""
    ...
    def _registrar_grupos(self):
        """Registra os grupos de PVs/LEDs e suas faixas."""
        self.sinais = {
            # 'SI-01B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led01b2b, 17, 42),
            'SI-01B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led01b1a, 17, 42),
            'SI-01B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led01b2a, 17, 42),
            # 'SI-01B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led01b1b, 17, 42),
            'SI-01B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led01b2fe, 17, 42),
            'SI-01BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led01bc, 17, 42),
            'SI-01C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led01c2, 17, 42),
            'SI-01BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led01bcfe, 17, 42),
            'SI-01SAFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led01safe, 17, 42),
            'SI-01M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led01m1, 17, 42),
            'SI-01C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led01c1, 17, 42),
            'SI-02B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led02b1a, 17, 42),
            'SI-02B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led02b1b, 17, 42),
            # 'SI-02B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led02b2a, 17, 42),
            'SI-02B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led02b2b, 17, 42),
            'SI-02BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led02bc, 17, 42),
            'SI-02BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led02bcfe, 17, 42),
            # 'SI-02C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led02c1, 17, 42),
            'SI-02C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led02c2, 17, 42),
            'SI-02M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led02m1, 17, 42),
            'SI-02SBFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led02sbfe, 17, 42),
            'SI-03B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led03b1a, 17, 42),
            'SI-03B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led03b1b, 17, 42),
            'SI-03B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led03b2a, 17, 42),
            # 'SI-03B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led03b2b, 17, 42),
            'SI-03B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led03b2fe, 17, 42),
            'SI-03BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led03bc, 17, 42),
            'SI-03BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led03bcfe, 17, 42),
            'SI-03C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led03c1, 17, 42),
            'SI-03C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led03c2, 17, 42),
            'SI-03M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led03m1, 17, 42),
            'SI-03SPFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led03spfe, 17, 42),
            'SI-04B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led04b1a, 17, 42),
            # 'SI-04B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led04b1b, 17, 42),
            # 'SI-04B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led04b2a, 17, 42),
            'SI-04B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led04b2b, 17, 42),
            'SI-04BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led04bc, 17, 42),
            'SI-04BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led04bcfe, 17, 42),
            'SI-04BCFE:VA-PT100-ED2:Temp-Mon': (self.uiobj.led04bcfe_2, 17,
                                                42),
            'SI-04C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led04c1, 17, 42),
            'SI-04C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led04c2, 17, 42),
            'SI-04M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led04m1, 17, 42),
            'SI-04SBFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led04sbfe, 17, 42),
            'SI-05B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led05b1a, 17, 42),
            # 'SI-05B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led05b1b, 17, 42),
            'SI-05B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led05b2a, 17, 42),
            'SI-05B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led05b2b, 17, 42),
            'SI-05B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led05b2fe, 17, 42),
            'SI-05BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led05bc, 17, 42),
            'SI-05BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led05bcfe, 17, 42),
            'SI-05C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led05c1, 17, 42),
            'SI-05C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led05c2, 17, 42),
            'SI-05M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led05m1, 17, 42),
            'SI-05SAFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led05safe, 17, 42),
            'SI-06B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led06b1a, 17, 42),
            # 'SI-06B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led06b1b, 17, 42),
            'SI-06B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led06b2a, 17, 42),
            'SI-06B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led06b2b, 17, 42),
            'SI-06BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led06bc, 17, 42),
            'SI-06BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led06bcfe, 17, 42),
            'SI-06BCFE:VA-PT100-ED2:Temp-Mon': (self.uiobj.led06bcfe_2, 17,
                                                42),
            'SI-06C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led06c1, 17, 42),
            'SI-06C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led06c2, 17, 42),
            'SI-06M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led06m1, 17, 42),
            'SI-06SBFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led06sbfe, 17, 42),
            'SI-07B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led07b1a, 17, 42),
            'SI-07B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led07b1b, 17, 42),
            'SI-07B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led07b2a, 17, 42),
            'SI-07B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led07b2b, 17, 42),
            'SI-07B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led07b2fe, 17, 42),
            'SI-07BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led07bc, 17, 42),
            'SI-07BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led07bcfe, 17, 42),
            'SI-07C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led07c1, 17, 42),
            'SI-07C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led07c2, 17, 42),
            'SI-07M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led07m1, 17, 42),
            'SI-08B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led08b1a, 17, 42),
            'SI-08B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led08b1b, 17, 42),
            'SI-08B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led08b2a, 17, 42),
            'SI-08B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led08b2b, 17, 42),
            'SI-08BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led08bc, 17, 42),
            'SI-08BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led08bcfe, 17, 42),
            'SI-08C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led08c1, 17, 42),
            'SI-08C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led08c2, 17, 42),
            'SI-08M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led08m1, 17, 42),
            # 'SI-08SBFE:VA-PT100-ED:Temp-Mon': sel(f.uiobj.led08sbfe 17, 42,),
            'SI-09B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led09b1a, 17, 42),
            'SI-09B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led09b1b, 17, 42),
            'SI-09B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led09b2a, 17, 42),
            'SI-09B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led09b2b, 17, 42),
            'SI-09B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led09b2fe, 17, 42),
            'SI-09BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led09bc, 17, 42),
            'SI-09BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led09bcfe, 17, 42),
            'SI-09C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led09c1, 17, 42),
            'SI-09C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led09c2, 17, 42),
            'SI-09M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led09m1, 17, 42),
            'SI-10B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led10b1a, 17, 42),
            'SI-10B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led10b1b, 17, 42),
            'SI-10B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led10b2a, 17, 42),
            'SI-10B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led10b2b, 17, 42),
            'SI-10BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led10bc, 17, 42),
            'SI-10BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led10bcfe, 17, 42),
            'SI-10C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led10c1, 17, 42),
            'SI-10C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led10c2, 17, 42),
            'SI-10M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led10m1, 17, 42),
            'SI-10M2:VA-PT100-ED:Temp-Mon': (self.uiobj.led10m2, 17, 42),
            'SI-11B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led11b1a, 17, 39),
            'SI-11B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led11b1b, 17, 39),
            'SI-11B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led11b2a, 17, 39),
            # 'SI-11B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led11b2b, 17, 39),
            'SI-11B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led11b2fe, 17, 39),
            'SI-11BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led11bc, 17, 39),
            'SI-11BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led11bcfe, 17, 39),
            'SI-11C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led11c1, 17, 39),
            'SI-11C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led11c2, 17, 39),
            'SI-11M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led11m1, 17, 39),
            'SI-12B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led12b1a, 17, 39),
            'SI-12B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led12b1b, 17, 39),
            'SI-12B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led12b2a, 17, 39),
            'SI-12B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led12b2b, 17, 39),
            'SI-12BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led12bc, 17, 39),
            'SI-12BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led12bcfe, 17, 39),
            'SI-12C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led12c1, 17, 39),
            'SI-12C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led12c2, 17, 39),
            'SI-12M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led12m1, 17, 39),
            'SI-12SBFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led12sbfe, 17, 39),
            'SI-13B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led13b1a, 17, 39),
            'SI-13B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led13b1b, 17, 39),
            'SI-13B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led13b2a, 17, 39),
            # 'SI-13B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led13b2b, 17, 39),
            'SI-13B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led13b2fe, 17, 39),
            'SI-13BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led13bc, 17, 39),
            'SI-13BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led13bcfe, 17, 39),
            'SI-13C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led13c1, 17, 39),
            'SI-13C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led13c2, 17, 39),
            'SI-13M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led13m1, 17, 39),
            'SI-13SAFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led13safe, 17, 39),
            'SI-14B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led14b1a, 17, 39),
            'SI-14B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led14b1b, 17, 39),
            'SI-14B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led14b2a, 17, 39),
            'SI-14B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led14b2b, 17, 39),
            'SI-14BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led14bc, 17, 39),
            'SI-14BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led14bcfe, 17, 39),
            'SI-14C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led14c1, 17, 39),
            'SI-14C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led14c2, 17, 39),
            'SI-14M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led14m1, 17, 39),
            'SI-14M2:VA-PT100-ED:Temp-Mon': (self.uiobj.led14m2, 17, 39),
            'SI-15B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led15b1a, 17, 39),
            'SI-15B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led15b1b, 17, 39),
            'SI-15B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led15b2a, 17, 39),
            'SI-15B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led15b2b, 17, 39),
            'SI-15B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led15b2fe, 17, 39),
            'SI-15BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led15bc, 17, 39),
            'SI-15BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led15bcfe, 17, 39),
            'SI-15C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led15c1, 17, 39),
            # 'SI-15C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led15c2, 17, 39),
            'SI-15M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led15m1, 17, 39),
            'SI-15SPFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led15spfe, 17, 39),
            'SI-16B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led16b1a, 17, 39),
            'SI-16B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led16b1b, 17, 39),
            # 'SI-16B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led16b2a, 17, 39),
            'SI-16B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led16b2b, 17, 39),
            'SI-16BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led16bc, 17, 39),
            'SI-16BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led16bcfe, 17, 39),
            'SI-16C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led16c1, 17, 39),
            'SI-16C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led16c2, 17, 39),
            'SI-16M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led16m1, 17, 39),
            'SI-16SBFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led16sbfe, 17, 39),
            'SI-17B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led17b1a, 17, 39),
            'SI-17B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led17b1b, 17, 39),
            'SI-17B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led17b2a, 17, 39),
            # 'SI-17B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led17b2b, 17, 39),
            'SI-17B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led17b2fe, 17, 39),
            # 'SI-17BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led17bc, 17, 39),
            # 'SI-17BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led17bcfe, 17, 39),
            'SI-17C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led17c1, 17, 39),
            'SI-17C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led17c2, 17, 39),
            'SI-17M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led17m1, 17, 39),
            'SI-17SA:VA-PT100-ED:Temp-Mon': (self.uiobj.led17sa, 17, 39),
            # 'SI-17SAFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led17safe, 17, 39),
            'SI-18B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led18b1a, 17, 39),
            'SI-18B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led18b1b, 17, 39),
            'SI-18B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led18b2a, 17, 39),
            'SI-18B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led18b2b, 17, 39),
            # 'SI-18BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led18bc, 17, 39),
            'SI-18BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led18bcfe, 17, 39),
            'SI-18C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led18c1, 17, 39),
            'SI-18C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led18c2, 17, 39),
            'SI-18M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led18m1, 19, 39),
            'SI-18SBFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led18sbfe, 19, 39),
            'SI-19B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led19b1a, 19, 39),
            'SI-19B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led19b1b, 19, 39),
            'SI-19B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led19b2a, 19, 39),
            'SI-19B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led19b2b, 19, 39),
            'SI-19B2FE:VA-PT100-ED:Temp-Mon': (self.uiobj.led19b2fe, 19, 39),
            'SI-19BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led19bc, 19, 39),
            'SI-19BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led19bcfe, 19, 39),
            'SI-19C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led19c1, 19, 39),
            'SI-19C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led19c2, 19, 39),
            'SI-19M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led19m1, 19, 39),
            'SI-19SPFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led19spfe, 19, 39),
            'SI-20B1A:VA-PT100-ED:Temp-Mon': (self.uiobj.led20b1a, 19, 39),
            'SI-20B1B:VA-PT100-ED:Temp-Mon': (self.uiobj.led20b1b, 19, 39),
            # 'SI-20B2A:VA-PT100-ED:Temp-Mon': (self.uiobj.led20b2a, 19, 39),
            'SI-20B2B:VA-PT100-ED:Temp-Mon': (self.uiobj.led20b2b, 19, 39),
            'SI-20BC:VA-PT100-ED:Temp-Mon': (self.uiobj.led20bc, 19, 39),
            'SI-20BCFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led20bcfe, 19, 39),
            'SI-20C1:VA-PT100-ED:Temp-Mon': (self.uiobj.led20c1, 19, 39),
            'SI-20C2:VA-PT100-ED:Temp-Mon': (self.uiobj.led20c2, 19, 39),
            'SI-20M1:VA-PT100-ED:Temp-Mon': (self.uiobj.led20m1, 19, 39),
            'SI-20SBFE:VA-PT100-ED:Temp-Mon': (self.uiobj.led20sbfe, 19, 39),
        }


class Si_magnets(ConnWidgetPVs):
    """Classe responsável pelo controle do sistema de temperatura Booster."""
    ...
    def _registrar_grupos(self):
        """Registra os grupos de PVs/LEDs e suas faixas."""
        self.sinais = {
            'SI-01-MBTemp-22-CH6': (self.uiobj.ledb2c3_22ch6, 19.5, 27.5),
            'SI-01-MBTemp-22-CH7': (self.uiobj.ledb2c3_22ch7, 19.5, 27.5),
            'SI-01-MBTemp-22-CH8': (self.uiobj.ledb2c3_22ch8, 19.5, 27.5),
            'SI-01-MBTemp-14-CH5': (self.uiobj.ledq1c1_14ch5, 19.5, 27.5),
            'SI-01-MBTemp-14-CH6': (self.uiobj.ledq1c1_14ch6, 19.5, 27.5),
            'SI-01-MBTemp-14-CH7': (self.uiobj.ledq1c1_14ch7, 19.5, 27.5),
            'SI-01-MBTemp-23-CH6': (self.uiobj.ledqfbm1_23ch6, 19.5, 27.5),
            'SI-01-MBTemp-23-CH7': (self.uiobj.ledqfbm1_23ch7, 19.5, 27.5),
            'SI-03-MBTemp-23-CH5': (self.uiobj.ledb1c4_23ch5, 19.5, 27.5),
            'SI-03-MBTemp-23-CH6': (self.uiobj.ledb1c4_23ch6, 19.5, 27.5),
            'SI-03-MBTemp-23-CH7': (self.uiobj.ledb1c4_13ch7, 19.5, 27.5),
            'SI-03-MBTemp-13-CH5': (self.uiobj.ledb2c3_13ch5, 19.5, 27.5),
            'SI-03-MBTemp-13-CH6': (self.uiobj.ledb2c3_13ch6, 19.5, 27.5),
            'SI-03-MBTemp-13-CH7': (self.uiobj.ledb2c3_13ch7, 19.5, 27.5),
            'SI-03-MBTemp-22-CH6': (self.uiobj.ledq3c3_22ch6, 19.5, 27.5),
            # 'SI-03-MBTemp-22-CH7': (self.uiobj.ledq3c3_22ch7, 19.5, 27.5),
            'SI-03-MBTemp-22-CH8': (self.uiobj.ledq3c3_22ch8, 19.5, 27.5),
            'SI-06-MBTemp-23-CH5': (self.uiobj.led06b1c4_23ch5, 19.5, 27.5),
            'SI-06-MBTemp-23-CH6': (self.uiobj.led06b1c4_23ch6, 19.5, 27.5),
            # 'SI-06-MBTemp-23-CH7': (self.uiobj.led06b1c4_23ch7, 19.5, 27.5),
            'SI-06-MBTemp-11-CH4': (self.uiobj.led06b2c2_11ch4, 19.5, 27.5),
            'SI-06-MBTemp-11-CH5': (self.uiobj.led06b2c2_11ch5, 19.5, 27.5),
            'SI-06-MBTemp-11-CH6': (self.uiobj.led06b2c2_11ch6, 19.5, 27.5),
            'SI-06-MBTemp-22-CH6': (self.uiobj.led06q3c3_22ch6, 19.5, 27.5),
            'SI-06-MBTemp-22-CH7': (self.uiobj.led06q3c3_22ch7, 19.5, 27.5),
            # 'SI-06-MBTemp-22-CH8': (self.uiobj.led06q3c3_22ch8, 19.5, 27.5),
            'SI-08-MBTemp-23-CH5': (self.uiobj.led08b1c4_23ch5, 19.5, 27.5),
            'SI-08-MBTemp-23-CH6': (self.uiobj.led08b1c4_23ch6, 19.5, 27.5),
            'SI-08-MBTemp-23-CH7': (self.uiobj.led08b1c4_23ch7, 19.5, 27.5),
            'SI-08-MBTemp-10-CH3': (self.uiobj.led08b2c2_10ch3, 19.5, 27.5),
            'SI-08-MBTemp-10-CH4': (self.uiobj.led08b2c2_10ch4, 19.5, 27.5),
            'SI-08-MBTemp-10-CH5': (self.uiobj.led08b2c2_10ch5, 19.5, 27.5),
            'SI-08-MBTemp-22-CH6': (self.uiobj.led08q3c3_22ch6, 19.5, 27.5),
            'SI-08-MBTemp-22-CH7': (self.uiobj.led08q3c3_22ch7, 19.5, 27.5),
            'SI-08-MBTemp-22-CH8': (self.uiobj.led08q3c3_22ch8, 19.5, 27.5),
            'SI-11-MBTemp-23-CH5': (self.uiobj.led11b1c4_23ch5, 19.5, 27.5),
            'SI-11-MBTemp-23-CH6': (self.uiobj.led11b1c4_23ch6, 19.5, 27.5),
            'SI-11-MBTemp-23-CH7': (self.uiobj.led11b1c4_23ch7, 19.5, 27.5),
            'SI-11-MBTemp-13-CH3': (self.uiobj.led11b2c2_13ch3, 19.5, 27.5),
            'SI-11-MBTemp-13-CH5': (self.uiobj.led11b2c2_13ch5, 19.5, 27.5),
            'SI-11-MBTemp-12-CH8': (self.uiobj.led11b2c2_12ch8, 19.5, 27.5),
            'SI-11-MBTemp-22-CH6': (self.uiobj.led11q3c3_22ch6, 19.5, 27.5),
            'SI-11-MBTemp-22-CH7': (self.uiobj.led11q3c3_22ch7, 19.5, 27.5),
            'SI-11-MBTemp-22-CH8': (self.uiobj.led11q3c3_22ch8, 19.5, 27.5),
            # 'SI-13-MBTemp-22-CH7': (self.uiobj.led22b2c3_22ch7, 19.5, 27.5),
            'SI-13-MBTemp-22-CH8': (self.uiobj.led22b2c3_22ch8, 19.5, 27.5),
            'SI-13-MBTemp-13-CH5': (self.uiobj.led13q1c1_13ch5, 19.5, 27.5),
            'SI-13-MBTemp-13-CH6': (self.uiobj.led13q1c1_13ch6, 19.5, 27.5),
            'SI-13-MBTemp-13-CH7': (self.uiobj.led13q1c1_13ch7, 19.5, 27.5),
            'SI-13-MBTemp-23-CH5': (self.uiobj.led13qfbm1_23ch5, 19.5, 27.5),
            # 'SI-13-MBTemp-23-CH6': (self.uiobj.led13qfbm1_23ch6, 19.5, 27.5),
            'SI-13-MBTemp-23-CH7': (self.uiobj.led13qfbm1_23ch7, 19.5, 27.5),
            'SI-16-MBTemp-22-CH6': (self.uiobj.led16b2c3_22ch6, 19.5, 27.5),
            'SI-16-MBTemp-22-CH7': (self.uiobj.led16b2c3_22ch7, 19.5, 27.5),
            'SI-16-MBTemp-22-CH8': (self.uiobj.led16b2c3_22ch8, 19.5, 27.5),
            'SI-16-MBTemp-11-CH6': (self.uiobj.led16q1c1_11ch6, 19.5, 27.5),
            'SI-16-MBTemp-11-CH7': (self.uiobj.led16q1c1_11ch7, 19.5, 27.5),
            'SI-16-MBTemp-11-CH8': (self.uiobj.led16q1c1_11ch8, 19.5, 27.5),
            'SI-16-MBTemp-23-CH5': (self.uiobj.led16qfbm1_23ch5, 19.5, 27.5),
            'SI-16-MBTemp-23-CH6': (self.uiobj.led16qfbm1_23ch6, 19.5, 27.5),
            'SI-16-MBTemp-23-CH7': (self.uiobj.led16qfbm1_23ch7, 19.5, 27.5),
            'SI-18-MBTemp-23-CH5': (self.uiobj.led18b1c4_23ch5, 19.5, 27.5),
            'SI-18-MBTemp-23-CH6': (self.uiobj.led18b1c4_23ch6, 19.5, 27.5),
            'SI-18-MBTemp-23-CH7': (self.uiobj.led18b1c4_23ch7, 19.5, 27.5),
            'SI-18-MBTemp-11-CH5': (self.uiobj.led18b2c2_11ch5, 19.5, 27.5),
            'SI-18-MBTemp-11-CH6': (self.uiobj.led18b2c2_11ch6, 19.5, 27.5),
            'SI-18-MBTemp-11-CH7': (self.uiobj.led18b2c2_11ch7, 19.5, 27.5),
            'SI-18-MBTemp-22-CH6': (self.uiobj.led18q3c3_22ch6, 19.5, 27.5),
            'SI-18-MBTemp-22-CH7': (self.uiobj.led18q3c3_22ch7, 19.5, 27.5),
            'SI-18-MBTemp-22-CH8': (self.uiobj.led18q3c3_22ch8, 19.5, 27.5),
        }


class Si_dclinks(ConnWidgetPVs):
    """Classe responsável pelo controle do sistema de temperatura Booster."""
...
class Si_rackpu_(QtWidgets.QWidget):
    ...
    def atualizar_status(self):
        ...
        for _, (sinais, temp_min, temp_max) in self.sinais_temprackpu.items():
            for signal, led in sinais.items():
                utils.verificar_temp(signal, led, temp_min, temp_max)
                if not getattr(led, "state", False):
                    todos_verdes = False
...
class Si_racksimar_(QtWidgets.QWidget):
...
class Si_roomrack_(QtWidgets.QWidget):
...
class Si_camvac_(QtWidgets.QWidget):
    """."""
...
class Si_conecserv_(QtWidgets.QWidget):
    """."""
...
class Si_magnets_(QtWidgets.QWidget):
    """."""
...
class Si_dclinks_(QtWidgets.QWidget):
    """."""
