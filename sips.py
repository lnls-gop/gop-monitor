    ...
    def _registrar_grupos(self):
        ...
        self.sinais = {
            ...
            "Quadrupolo_rectifiert": {
                ...
                (self._gwidget('led07q24a_rectifier'), 33, 38),
                'PA-RaPSA07:PS-DCLink-Q24B:RectifierT-Mon':
                (self._gwidget('led07q24b_rectifier'), 33.5, 38.5),
                'PA-RaPSA07:PS-DCLink-Q24C:RectifierT-Mon':
                (self._gwidget('led07q24c_rectifier'), 33, 37),
            },
            "Quadrupolo_pcbt": {
            ...
            "SextDef_igbtt": {
                ...
                # 'PA-RaPSB07:PS-DCLink-SFA2SDP1:IGBTT-Mon':
                # (self._gwidget('ledsfa2sdp1_igbt'), 28.7, 33.7),
            ...
            "SextDef_rectifiert": {
                ...
                # 'PA-RaPSB07:PS-DCLink-SFA2SDP1:RectifierT-Mon':
                # (self._gwidget('ledsfa2sdp1_rectifier'), 28, 33),
            ...
            "SextDef_pcbt": {
                ...
                # 'PA-RaPSB07:PS-DCLink-SFA2SDP1:PCBT-Mon':
                # (self._gwidget('ledsfa2sdp1_pcb'), 27, 31),
    ...
    def _registrar_grupos(self):
        ...
        self.sinais = {
            ...
            'SI-17B2FE:VA-PT100-ED:Temp-Mon': (self._gwidget
                                               ('led17b2fe'), 17, 39),
            'SI-17BC:VA-PT100-ED:Temp-Mon': (self._gwidget('led17bc'), 17, 39),
...
class Si_circhid(utils.ConnWidgetPVs):
    ...
    def _registrar_grupos(self):
        """Registra os grupos de PVs/LEDs e suas faixas."""
        self.sinais = {
            'SI-08-MBTemp-10-CH6': (self._gwidget('led10ch6'), 22, 25),
            'SI-18-MBTemp-13-CH5': (self._gwidget('led13ch5'), 20, 24),
            'SI-18-MBTemp-13-CH6': (self._gwidget('led13ch6'), 19, 22),
            'SI-08-MBTemp-10-CH8': (self._gwidget('led10ch8'), 23, 25),
            'SI-18-MBTemp-13-CH7': (self._gwidget('led13ch7'), 24, 28),
            ...
            (self._gwidget('ledqdainductor'), 21, 24),
            'SI-Fam:PS-QDA:HeatSinkTemperatureIIB-Mon':
            (self._gwidget('ledqdaheatsink'), 18.5, 23),
            'SI-Fam:PS-SDA0:HeatSinkTemperatureIIB-Mon':
            (self._gwidget('ledsda0heatsink'), 18.5, 23),
            'SI-Fam:PS-SFP1:HeatSinkTemperatureIIB-Mon':
            (self._gwidget('ledsfp1heatsink'), 21, 24),
